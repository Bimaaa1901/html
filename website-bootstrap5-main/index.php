<?php
include 'fungsi.php'; // File yang berisi fungsi bacaData() dan simpanData()
        ...
        <div class="row pb-3">
          <div class="col-md-6">
            ...
            <input
              ...
              name="PHONE"
            />
            <button type="submit" method="POST" class="btn btn-danger btn-lg">
            Kirim Pesan
          </button>
          <br>
          </div>
          ...
          <!-- <div class="col-md-6">
            <textarea class="form-control form-control-lg" rows="5"><?= $tugas['NAMA'] ?></textarea>
          </div> -->

           
          <?php foreach ($dataTugas as $index => $tugas): ?>
            <tr>
            <td><?= $index + 1; ?></td><br>
            <td><?= $tugas['NAMA'] ?></td><br>
            <td><?= $tugas['EMAIL']?></td><br>
            <td><?= $tugas['PHONE']?></td><br>
